...
A validation sample was collected within other studies (overall N=379 participants) for which factor analyses revealed six emotional breakthrough items with high internal consistency (Cronbach’s alpha=0.932). These are rated using a visual analogue scale (VAS) (0–100, with incremental units of one) with zero defined as ‘No, not more than usually’, and 100 defined as ‘Yes, entirely or completely’. Note: These is the same VAS and anchors as used in the ASC-R and in the EDI. This makes it very convenient to add these items to a retrospective assessment, as they do not need additional instructions:
