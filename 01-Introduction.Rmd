...
| Questionnaire  | Version | # items  | # (Sub)scales | response format 
|-----------|-----------|-----------|-----------|-----------|
...
| Mystical Experience Questionnaire | MEQ <br />  MEQ30 <br /> MEQ-4 <br /> SOCQ <br /> PES48 | 130 <br /> 30 <br />  4 <br /> 100 <br /> 48 | 8+9  <br />  4(FA) <br /> 4 <br />7 <br /> 8  | 6-point <br /> 6-point <br /> 6-point <br /> 6-point <br /> 6-point |
| Challenging Experience Questionnaire | CEQ <br />  CEQ-7 | 26 <br /> 7 <br />  |  7 <br /> 7 <br /> |  6-point <br /> 6-point <br />  |
| Psychological Insight Questionnaire | PIQ | 23 | 2 | 6-point|
| Watts Connectedness Scale | WCS | 23 | 3 | VAS |

__Table 1__ _Overview of the most popular questionnaires and their versions that are used to assess ASC phenomena in current research. VAS: Visual Analog Scale; FA: Factor Analysis_


In addition to these questionnaires, we included descriptions of additional questionnaires which have been used in the field, but are only rarely used in recent research. Therefore, they are included rather for historic reasons to give inspirations for future development of new tools.


| Questionnaire  | Version | # items  | # (sub)scales | response format 
|-----------|-----------|-----------|-----------|-----------|
| Psychometric States Inventory | PSI | 48 | 6(FA)  | 4-point |
| Abramson Questionnaire  | AQ | 47 | 1 |  6-point |
| Linton & Lang Questionnaire | LLQ | 74 | 17 | 3-point  |
| Near-Death Experience Scale | NDE | 33 | 4 | 3-point  |
| The Mysticism Scale | M-Scale | 32 | 3 | 9-point |
| Personal Experience Questionnaire | PEQ | 44 |  | Yes/No |
| Assessment Schedule for Altered States of Consciousness | ASACS | 60 | 5 |  |
| Addiction Research Center Inventory | ARCI long-form <br /> ARCI short-form | 550 <br /> 49 | 38 <br /> 5 | Yes/No <br /> Yes/No |
__Table 2__ _Further questionnaires and their versions that are of historical interest but rarely used in current research._


Besides the above questionnaires which aim to quantify acute ASC phenomena, we included an additional section with questionnaires that aim to quantify subacute effects, sometimes called aftereffects, or in the context of psychedelics "afterglow".


| Questionnaire  | Version | # items  | # (sub)scales | response format 
|-----------|-----------|-----------|-----------|-----------|
| Afterglow Inventory | AGI | 24 | 5 | VAS |
| Persisting Effects Questionnaire | PEQ | 89| 8 | 6,7,8-point |

__Table 3__ _Overview of additional questionnaires. VAS: Visual Analog Scale; FA: Factor Analysis_
